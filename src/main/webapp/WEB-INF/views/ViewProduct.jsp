...
<section class="section-products">
	<div class="container">
		...
		<div class="row">
			<div class="col-md-6 col-lg-4 col-xl-4.5">
			</div>
			<div class="col-md-6 col-lg-4 col-xl-3">
				<div id="product-1" class="single-product">
					<div class="part-1">
						<img src="${product.productImagePath}" height="105%" width="105%"/>
					</div>
					<div class="part-2">
						<h3 class="product-title">${product.productName }</h3>
						<h4 class="product-old-price">${((product.price)*0.05)+(product.price) }</h4>
